...
struct NiceButtonStyle: ButtonStyle {
  ...
  var gradientOverlayColor: [Color] {
    switch colorScheme {
    case .light:
      return [.clear, .blue.opacity(0.05), .clear]
    case .dark:
      return [.offWhite.opacity(0.05), .offWhite.opacity(0.05)]
    @unknown default:
      return [.offWhite.opacity(0.05), .offWhite.opacity(0.05)]
    }
  }
  ...
  func makeBody(configuration: Configuration) -> some View {
    ZStack {
      configuration
        .label
        .foregroundColor(isHovering ? .primary : .blue)
        .fontWeight(.bold)
        .fontDesign(.rounded)
    }
